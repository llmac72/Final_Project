...
formattable(Bridge, list(District=FALSE, County=FALSE, Route=FALSE, Miles=FALSE, `2021`=FALSE, `2022`=FALSE, `2023`=FALSE, `2024`=FALSE, `2025`=FALSE))
...
Over the five year period there is a difference of over 20% between the two plans.  This leds me to further believe there is something else going on with the pavement projects listed in the 5 Year Program that isn't easily identified without discussions with the Iowa DOT.
